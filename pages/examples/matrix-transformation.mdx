...
import { VecI, VecJ } from '../../components/math.js';

# Matrix Transformation example

This animation is interactive.
When all the transformations have been applied, you can drag both the <VecI /> vector
and the <VecJ /> vector.

<Scene src="/examples/matrix_transformation.html" />
